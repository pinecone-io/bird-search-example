"""Local SigLIP embedding backend — the default (see ``embedder.py``).
...
Output dimension matches the alternative Gemini backend's (768), so
switching providers requires no Pinecone schema change.
"""
